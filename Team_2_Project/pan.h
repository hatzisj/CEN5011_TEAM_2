...
#define PanSource	"C:\\Documents\ and\ Settings\\Greg\\workspace\\CEN5011_TEAM_2\\Team_2_Project\\abp.pml"
...
#define nstates1	24	/* :init: */
#define minseq1	348
#define maxseq1	370
#define endstate1	23

#define nstates0	349	/* Main */
#define minseq0	0
#define maxseq0	347
#define endstate0	348
...
struct type_CDataOut { /* user defined type */
	int CDataOut_field1;
	int CDataOut_field2;
};
struct type_CAckIn { /* user defined type */
	int CAckIn_field1;
};
struct type_CAckOut { /* user defined type */
	int CAckOut_field1;
};
struct type_CDataIn { /* user defined type */
	int CDataIn_field1;
	int CDataIn_field2;
};
struct type_DataIn { /* user defined type */
	int DataIn_field1;
	int DataIn_field2;
};
struct type_Deliver { /* user defined type */
	int Deliver_field1;
};
struct type_AckOut { /* user defined type */
	int AckOut_field1;
};
struct type_AckBuf { /* user defined type */
	int AckBuf_field1;
};
struct type_Accept { /* user defined type */
	int Accept_field1;
};
struct type_DataBuf { /* user defined type */
	int DataBuf_field1;
	int DataBuf_field2;
};
struct type_DataOut { /* user defined type */
	int DataOut_field1;
	int DataOut_field2;
};
struct type_AckIn { /* user defined type */
	int AckIn_field1;
};
typedef struct P2 { /* f */
...
typedef struct P1 { /* :init: */
	...
	unsigned _priority : 8; /* 0..255 */
#endif
	struct type_CDataOut CDataOut;
	struct type_CAckIn CAckIn;
	struct type_CAckOut CAckOut;
	struct type_CDataIn CDataIn;
	struct type_DataIn DataIn;
	struct type_Deliver Deliver;
	struct type_AckOut AckOut;
	struct type_AckBuf AckBuf;
	struct type_Accept Accept;
	struct type_DataBuf DataBuf;
	struct type_DataOut DataOut;
	struct type_AckIn AckIn;
} P1;
#define Air1	0
...
typedef struct P0 { /* Main */
	...
	unsigned _priority : 8; /* 0..255 */
#endif
	unsigned corrupted_is_enabled : 1;
	unsigned transmitted_is_enabled : 1;
	unsigned lost_is_enabled : 1;
	unsigned corrupted_ack_is_enabled : 1;
	unsigned transmitted_ack_is_enabled : 1;
	unsigned lost_ack_is_enabled : 1;
	unsigned deliverData_is_enabled : 1;
	unsigned resendAck_is_enabled : 1;
	unsigned sendData_is_enabled : 1;
	unsigned resendData_is_enabled : 1;
	unsigned Conn5_is_enabled : 1;
	unsigned Conn4_is_enabled : 1;
	unsigned Conn3_is_enabled : 1;
	unsigned Conn2_is_enabled : 1;
	struct type_CDataOut CDataOut;
	struct type_CAckIn CAckIn;
	struct type_CAckOut CAckOut;
	struct type_CDataIn CDataIn;
