...
public class Place 
   ...
   /**	Su Liu: For the purpose of model checking High Level Petri net, we set capacity to bound
    * 		place tokens.
    */
  ...
  */
   ...
   public ArrayList<Transition> getTransOutList(){
	   ...
	   while(arcIterator.hasNext()){
		   ...
		   transOutList.add((Transition)thisArc.getTarget());
	   }
