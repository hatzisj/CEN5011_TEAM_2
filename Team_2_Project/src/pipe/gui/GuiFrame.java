...
public class GuiFrame
   ...
   private AnimateAction startAction, stepforwardAction, stepbackwardAction,
           randomLowLevelAction, randomHighLevelAction, randomAnimateAction;
   ...
   public sam_model.Component curComponent;
   ...
   private void buildMenus() {
      ...
      addMenuItem(animateMenu, randomLowLevelAction =
              new AnimateAction("RandomLowLevel", Pipe.RANDOMLOWLEVEL,
...
//      toggleGrid.setEnabled(status);
   ...
   public void setTab(sam_model.Component curComp){
 ...
 */
   ...
   public void loadElemSpecTab(sam_model.Component curComp) throws ParserConfigurationException, TransformerFactoryConfigurationError, TransformerException{
	   int freeSpace = CreateGui.getFreeSpace();
      ...
      public void actionPerformed(ActionEvent ae){
         ...
         switch(typeID){
            ...
            case Pipe.RANDOMHIGHLEVEL:
                animBox.clearStepsForward();
                CreateGui.getAnimator().doHighLevelRandomFiring();
                stepforwardAction.setEnabled(animBox.isStepForwardAllowed());
                stepbackwardAction.setEnabled(animBox.isStepBackAllowed());
                break;
